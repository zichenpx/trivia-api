...
def create_app(test_config=None):
    ...
    """
    @TODO: Set up CORS. Allow "*" for origins. Delete the sampleroute after completing the TODOs
    """
    ...
    """
    Delete Category
    Delete Category when no questions existing in
    """
    ...
    def delete_category(c_id):
        ...
        questions_in_category = Question.query.filter(Question.category == c_id).all()
        # questions_in_category = Question.query.filter(Question.category == c_id).first()
        ...
        try:
            ...
            result = {
                "success": True,
                "deleted": c_id,
                "message": "Category No." + str(c_id) + " " + category_type + " was successfully deleted"
            }
            return jsonify(result), 201
    ...
    def delete_question(q_id):
        ...
        try:
            ...
            result = {
                ...
                "id": q_id,
                "deleted": q_id,
                "message": "Question No." + str(q_id) + " " + question_q + " was successfully deleted"
            }
            return jsonify(result), 201
